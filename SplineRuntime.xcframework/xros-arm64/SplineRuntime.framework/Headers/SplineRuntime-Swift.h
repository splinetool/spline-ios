...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
static inline const constexpr bool isUsableInGenericContext<SplineRuntime::SplineImmersiveSpaceContent> = true;
#pragma clang diagnostic pop
} // namespace swift
...
class _impl_SplineImmersiveSpaceContent;

// Type metadata accessor for SplineImmersiveSpaceContent
SWIFT_EXTERN swift::_impl::MetadataResponseTy $s13SplineRuntime0A21ImmersiveSpaceContentVMa(swift::_impl::MetadataRequestTy) SWIFT_NOEXCEPT SWIFT_CALL;


} // namespace _impl

class SWIFT_SYMBOL("s:13SplineRuntime0A21ImmersiveSpaceContentV") SplineImmersiveSpaceContent final {
public:
  SWIFT_INLINE_THUNK ~SplineImmersiveSpaceContent() noexcept {
    auto metadata = _impl::$s13SplineRuntime0A21ImmersiveSpaceContentVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
#else
  ...
  SWIFT_INLINE_THUNK SplineImmersiveSpaceContent(const SplineImmersiveSpaceContent &other) noexcept {
    auto metadata = _impl::$s13SplineRuntime0A21ImmersiveSpaceContentVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
  ...
  SWIFT_INLINE_THUNK SplineImmersiveSpaceContent &operator =(const SplineImmersiveSpaceContent &other) noexcept {
    auto metadata = _impl::$s13SplineRuntime0A21ImmersiveSpaceContentVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
  ...
  SWIFT_INLINE_THUNK SplineImmersiveSpaceContent &operator =(SplineImmersiveSpaceContent &&other) = delete;
  [[noreturn]] SWIFT_INLINE_PRIVATE_HELPER SplineImmersiveSpaceContent(SplineImmersiveSpaceContent &&) noexcept {
  swift::_impl::_fatalError_Cxx_move_of_Swift_value_type_not_supported_yet();
  swift::_impl::_swift_stdlib_reportFatalError("swift", 5, "C++ does not support moving a Swift value yet", 45, 0);
  abort();
  }
private:
  SWIFT_INLINE_THUNK SplineImmersiveSpaceContent(swift::_impl::ValueWitnessTable * _Nonnull vwTable) noexcept : _storage(vwTable->size, vwTable->getAlignment()) {}
  static SWIFT_INLINE_THUNK SplineImmersiveSpaceContent _make() noexcept {
    auto metadata = _impl::$s13SplineRuntime0A21ImmersiveSpaceContentVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
    ...
    auto *vwTable = *vwTableAddr;
#endif
    return SplineImmersiveSpaceContent(vwTable);
  }
  SWIFT_INLINE_THUNK const char * _Nonnull _getOpaquePointer() const noexcept { return _storage.getOpaquePointer(); }
  SWIFT_INLINE_THUNK char * _Nonnull _getOpaquePointer() noexcept { return _storage.getOpaquePointer(); }

  swift::_impl::OpaqueStorage _storage;
  friend class _impl::_impl_SplineImmersiveSpaceContent;
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wc++17-extensions"
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wreserved-identifier"
  typedef char $s13SplineRuntime0A21ImmersiveSpaceContentVD;
  static inline constexpr $s13SplineRuntime0A21ImmersiveSpaceContentVD __swift_mangled_name = 0;
#pragma clang diagnostic pop
#pragma clang diagnostic pop
};
...
class _impl_SplineImmersiveSpaceContent {
public:
  static SWIFT_INLINE_THUNK char * _Nonnull getOpaquePointer(SplineImmersiveSpaceContent &object) { return object._getOpaquePointer(); }
  static SWIFT_INLINE_THUNK const char * _Nonnull getOpaquePointer(const SplineImmersiveSpaceContent &object) { return object._getOpaquePointer(); }
  template<class T>
  static SWIFT_INLINE_PRIVATE_HELPER SplineImmersiveSpaceContent returnNewValue(T callable) {
    auto result = SplineImmersiveSpaceContent::_make();
    callable(result._getOpaquePointer());
    return result;
  }
  static SWIFT_INLINE_THUNK void initializeWithTake(char * _Nonnull destStorage, char * _Nonnull srcStorage) {
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
struct TypeMetadataTrait<SplineRuntime::SplineImmersiveSpaceContent> {
  static SWIFT_INLINE_THUNK void * _Nonnull getTypeMetadata() {
    return SplineRuntime::_impl::$s13SplineRuntime0A21ImmersiveSpaceContentVMa(0)._0;
  }
};
namespace _impl{
template<>
static inline const constexpr bool isValueType<SplineRuntime::SplineImmersiveSpaceContent> = true;
template<>
static inline const constexpr bool isOpaqueLayout<SplineRuntime::SplineImmersiveSpaceContent> = true;
template<>
struct implClassFor<SplineRuntime::SplineImmersiveSpaceContent> { using type = SplineRuntime::_impl::_impl_SplineImmersiveSpaceContent; };
} // namespace
#pragma clang diagnostic pop
} // namespace swift
...
class SWIFT_SYMBOL("s:13SplineRuntime0A17VolumetricContentV") SplineVolumetricContent;
} // end namespace 
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
static inline const constexpr bool isUsableInGenericContext<SplineRuntime::SplineVolumetricContent> = true;
#pragma clang diagnostic pop
} // namespace swift
...
class _impl_SplineVolumetricContent;

// Type metadata accessor for SplineVolumetricContent
SWIFT_EXTERN swift::_impl::MetadataResponseTy $s13SplineRuntime0A17VolumetricContentVMa(swift::_impl::MetadataRequestTy) SWIFT_NOEXCEPT SWIFT_CALL;


} // namespace _impl

class SWIFT_SYMBOL("s:13SplineRuntime0A17VolumetricContentV") SplineVolumetricContent final {
public:
  SWIFT_INLINE_THUNK ~SplineVolumetricContent() noexcept {
    auto metadata = _impl::$s13SplineRuntime0A17VolumetricContentVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
#else
  ...
  SWIFT_INLINE_THUNK SplineVolumetricContent(const SplineVolumetricContent &other) noexcept {
    auto metadata = _impl::$s13SplineRuntime0A17VolumetricContentVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
  ...
  SWIFT_INLINE_THUNK SplineVolumetricContent &operator =(const SplineVolumetricContent &other) noexcept {
    auto metadata = _impl::$s13SplineRuntime0A17VolumetricContentVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
  ...
  SWIFT_INLINE_THUNK SplineVolumetricContent &operator =(SplineVolumetricContent &&other) = delete;
  [[noreturn]] SWIFT_INLINE_PRIVATE_HELPER SplineVolumetricContent(SplineVolumetricContent &&) noexcept {
  swift::_impl::_fatalError_Cxx_move_of_Swift_value_type_not_supported_yet();
  swift::_impl::_swift_stdlib_reportFatalError("swift", 5, "C++ does not support moving a Swift value yet", 45, 0);
  abort();
  }
private:
  SWIFT_INLINE_THUNK SplineVolumetricContent(swift::_impl::ValueWitnessTable * _Nonnull vwTable) noexcept : _storage(vwTable->size, vwTable->getAlignment()) {}
  static SWIFT_INLINE_THUNK SplineVolumetricContent _make() noexcept {
    auto metadata = _impl::$s13SplineRuntime0A17VolumetricContentVMa(0);
    auto *vwTableAddr = reinterpret_cast<swift::_impl::ValueWitnessTable **>(metadata._0) - 1;
#ifdef __arm64e__
    auto *vwTable = reinterpret_cast<swift::_impl::ValueWitnessTable *>(ptrauth_auth_data(reinterpret_cast<void *>(*vwTableAddr), ptrauth_key_process_independent_data, ptrauth_blend_discriminator(vwTableAddr, 11839)));
    ...
    auto *vwTable = *vwTableAddr;
#endif
    return SplineVolumetricContent(vwTable);
  }
  SWIFT_INLINE_THUNK const char * _Nonnull _getOpaquePointer() const noexcept { return _storage.getOpaquePointer(); }
  SWIFT_INLINE_THUNK char * _Nonnull _getOpaquePointer() noexcept { return _storage.getOpaquePointer(); }

  swift::_impl::OpaqueStorage _storage;
  friend class _impl::_impl_SplineVolumetricContent;
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wc++17-extensions"
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wreserved-identifier"
  typedef char $s13SplineRuntime0A17VolumetricContentVD;
  static inline constexpr $s13SplineRuntime0A17VolumetricContentVD __swift_mangled_name = 0;
#pragma clang diagnostic pop
#pragma clang diagnostic pop
};
...
class _impl_SplineVolumetricContent {
public:
  static SWIFT_INLINE_THUNK char * _Nonnull getOpaquePointer(SplineVolumetricContent &object) { return object._getOpaquePointer(); }
  static SWIFT_INLINE_THUNK const char * _Nonnull getOpaquePointer(const SplineVolumetricContent &object) { return object._getOpaquePointer(); }
  template<class T>
  static SWIFT_INLINE_PRIVATE_HELPER SplineVolumetricContent returnNewValue(T callable) {
    auto result = SplineVolumetricContent::_make();
    callable(result._getOpaquePointer());
    return result;
  }
  static SWIFT_INLINE_THUNK void initializeWithTake(char * _Nonnull destStorage, char * _Nonnull srcStorage) {
...
#pragma clang diagnostic ignored "-Wc++17-extensions"
template<>
struct TypeMetadataTrait<SplineRuntime::SplineVolumetricContent> {
  static SWIFT_INLINE_THUNK void * _Nonnull getTypeMetadata() {
    return SplineRuntime::_impl::$s13SplineRuntime0A17VolumetricContentVMa(0)._0;
  }
};
namespace _impl{
template<>
static inline const constexpr bool isValueType<SplineRuntime::SplineVolumetricContent> = true;
template<>
static inline const constexpr bool isOpaqueLayout<SplineRuntime::SplineVolumetricContent> = true;
template<>
struct implClassFor<SplineRuntime::SplineVolumetricContent> { using type = SplineRuntime::_impl::_impl_SplineVolumetricContent; };
} // namespace
#pragma clang diagnostic pop
} // namespace swift
